...
#save_path = './lte02300-0.00-0.0.PHOENIX-NewEra-ACES-COND-2023.HSR.h5'
...
if(Teff >= 5000.): url = FDRV3+target+'?download=1'
save_file = './'+target

#print(url)
#print(save_file)
ierr = download_file(url, save_file)
#print(ierr)

# if there is an error, try the 'additional' model set (added after paper was published)
if(ierr <0):
  url = FDRADD+target+'?download=1'
  #print(url)
  #print(save_file)
  ierr = download_file(url, save_file)

if(ierr < 0): print("Model not in repository")
