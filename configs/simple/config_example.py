...
free_params = {
    ...
    'T_0' : ([7000,12000], r'$T_0$', 'uniform'), # bottom of the atmosphere (usually hotter)
    'T_1' : ([2000,8000], r'$T_1$', 'uniform'),
    'T_2' : ([2000,8000], r'$T_2$', 'uniform'),
    'T_3' : ([2000,8000], r'$T_3$', 'uniform'),
    'T_4' : ([2000,8000], r'$T_4$', 'uniform'), # top of atmosphere (usually cooler)
